...
try:
    import sys
    from pathlib import Path
    # Add root GitHub dir to path to find src/api/metrics_mount
...
# Include RAG routes
if RAG_ROUTES_AVAILABLE and rag_router:
    app.include_router(rag_router)
    logger.info("✅ RAG (Knowledge Base) routes loaded")
...
if AI_TEAM_AVAILABLE:
    ...
    logger.info("✅ AI Team orchestration routes loaded")
