...
#ifndef XCTVAPOR_SWIFT_H
#define XCTVAPOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XCTVapor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSInvocation;
SWIFT_CLASS("_TtC8XCTVapor13XCTVaporTests")
@interface XCTVaporTests : XCTestCase
