...
final class AppDelegate: NSObject, NSApplicationDelegate {
    func applicationDidFinishLaunching(_ notification: Notification) {
        // Initialize avatar notification service for iOS/macOS notifications
        _ = AvatarNotificationService.shared

        // Initialize mobile metrics service
        _ = MobileMetricsService.shared

        // Track app launch
        MobileMetricsService.shared.trackAppLifecycle(event: "launch")
