...
struct MetaPromptInfo: Codable, Equatable {
    ...
    var interactionId: String? = nil  // For bandit feedback
    var promptVariant: String? = nil  // Which prompt variant was used
    var banditEnabled: Bool = false    // Whether bandit was active
}
...
extension MetaPromptInfo {
    ...
    mutating func merge(from jsonDict: [String: Any]) {
        ...
        if interactionId == nil, let iid = jsonDict["interaction_id"] as? String { interactionId = iid }
